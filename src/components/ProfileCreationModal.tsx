...
export default function ProfileCreationModal({ isOpen, onClose, onProfileCreated }: ProfileCreationModalProps) {
  ...
  return (
    <div className="modal-overlay profile-modal" onClick={handleClose}>
      <div className="modal-content adj" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          <button
            className="create-button btn-new-profile"
